...
<html>
    ...
    <body id="_1">
        ...
        <ul id="nav-bar" style="width:100%;">
            <a href="index.php"><li id="home"><span class="glyphicon glyphicon-search"></span>Search</li></a>
        ...
        <div id="content">
            ...
            <?php $n = 1; $nul=0; while( $row = mysqli_fetch_assoc($r) ) { ?>
                        ...
                        <div id="qa-block">
                            <div class="question">
                                <div id="Q">•</div><?php echo $row["question"]."<small id='sml'>Asked By: @".$row['askedby']."</small>"; ?>
                            </div>
                            <div class="answer">
                                <?php
                                    if($row["answer"]){
